            ...
            <div className={styles.articleCon}>
              <div className={styles.shadowCon}>
                <div className={styles.article}>
                  <div className={styles.title}>{theData.userName}的求购 > {theData.name}</div>
                ...
                <Affix offsetTop={0} offsetBottom={0}>
                  <div className={styles.handleCon} onMouseEnter={this.seeReport} onMouseLeave={this.hiddenReport}>
                    <div className={styles.handleBtn}>
                      {
                        ...
                        <span style={{color:'#ed3624'}} onClick={this.showCollect.bind(this,true)}><i className={styles.iconHasCollect}></i>取消收藏 {theData.collect_qty}</span>
                        :<span onClick={this.showCollect.bind(this,false)}><i className={styles.iconCollect}></i><span className={styles.collectText}>收藏 {theData.collect_qty}</span></span>
                      }
                    ...
                    <div className={styles.addBtn}>
                      {/* <span className={styles.freeDown}><i></i>免费下载</span> */}
                      <span className={styles.addToBasket} onClick={this.showBuilding}><i></i>回应求购</span>
                    </div>
                  </div>
                </Affix>
              </div>
