...
class ChooseBook extends Component {
  ...
  getBookData = (bookId)=> {
    ...
    dispatch({
      type: 'knowledgetree/getBookInfo2',
      payload:{
  ...
  getTeacherBook = ()=> {
    ...
    dispatch({
      type: 'knowledgetree/getTeacherBook',
      payload:{
        payloadPeriod: {
  ...
  getBooksList = (e)=> {
    ...
    if(!!subject_id) {
      dispatch({
        type: 'knowledgetree/getBooksList',
        payload:{
          method:'/res/resBook/getAll',
          period_id: period_id,
          grade_id: grade_id,
