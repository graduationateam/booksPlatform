...
import $ from  'jquery'
class Zwebupload extends  Component {
    constructor(props){
        super(props);
        this.state={
          id:this.props.id?this.props.id:'upload',              //初始化的webuploader组件ID
          initData:this.props.initData?this.props.initData:{},  //初始化的文件对象 id、resource_url、file_name、file_size、file_type
          many:this.props.many?true:false,                      //是否支持多文件上传 默认不支持
          ...
          uploader:this.props.uploader?this.props.uploader:null,
        }
      }
    ...
    componentDidMount(){
        const {id,many,serverUrl,auto,initData}=this.state;
        ...
        if(initData.id){
            var obj ={};
            obj.name = initData.file_name;
            obj.size = initData.file_size;
            obj.id = initData.id;
            obj.ext = initData.file_type;
            ...
            <div id={id} className="uploader">
                <div className="queueList">
                    <div id="dndArea" className="placeholder">
                        <div className="filePicker" id="filePicker"></div>
                    </div>
                    <ul id="filelist" className="filelist"></ul>
                </div>
